package com.t.emlearn.ui.view.chat.widget;
...
import com.t.emlearn.ui.view.chat.utils.AudioManager;
import com.t.emlearn.ui.view.chat.utils.FileSaveUtil;
...
public class AudioRecordButton extends androidx.appcompat.widget.AppCompatButton implements AudioManager.AudioStageListener {
	...
	private void changeState(int state) {
		...
		if (mCurrentState != state) {
			...
			case STATE_NORMAL:
				setBackgroundResource(R.drawable.chat_button_recordnormal);
