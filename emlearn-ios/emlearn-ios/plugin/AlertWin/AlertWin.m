...
+ (void)showAlertWithStyle:(EMAlertViewStyle)aStyle
                   message:(NSString *)aMessage
{
    AlertWin *view = [[AlertWin alloc] initWithStyle:aStyle message:aMessage];
...
{
    [AlertWin showAlertWithStyle:EMAlertViewStyleError message:aMessage];
}

+ (void)showSuccessAlert:(NSString *)aMessage
{
    [AlertWin showAlertWithStyle:EMAlertViewStyleSuccess message:aMessage];
}

+ (void)showInfoAlert:(NSString *)aMessage
{
    [AlertWin showAlertWithStyle:EMAlertViewStyleInfo message:aMessage];
}
